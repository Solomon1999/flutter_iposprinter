 ...
 * PrintingPlugin
 */
class IPosPrinterFlutterPlugin implements FlutterPlugin, ActivityAware, MethodChannel.MethodCallHandler  {
    ...
    public static void registerWith(Registrar registrar) {
        final IPosPrinterFlutterPlugin instance = new IPosPrinterFlutterPlugin();
